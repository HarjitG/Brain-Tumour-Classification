...
class CNNModel:
    ...
    def build_model(self,
        ...
        self.model.add(Conv2D(16, (3,3), 1, activation = 'relu', input_shape = self.input_shape))
    ...
    def train(self, training_data, validation_data, epochs=1, log_dir=None, patience=3):
        if log_dir is None:
        ...
        hist = self.model.fit(training_data, validation_data, epochs = 1, callbacks = [tensorboard_callback, early_stopping])
